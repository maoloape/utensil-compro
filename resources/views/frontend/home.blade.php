...
@section('content')
    ...
    <!-- Section 1 -->
    <div class="mx-auto" style="max-width: 1740px; padding: 120px 0;">
        <div class="py-12">
            <div class="row g-4">
                <div class="col-md-4">
                    <div class="text-left">
                        <img src="{{ asset('assets/asset/logo.png') }}" alt="Logo" style="margin-bottom: 36px" width="auto" height="100">
                        ...
                        <div class="col">
                            <div class="text-center" 
                                ...
                                <div style="position: absolute;
                                        ...
                                        right: 0;
                                        bottom: 0;
                                        background: linear-gradient(to top, rgba(42, 42, 42, 0.4), rgba(42, 42, 42, 0));
                                        border-radius: 18px;">
    ...
    <div class="mx-auto" 
        style="margin-top: 0; padding: 60px 0;
        background: linear-gradient(to top, rgba(42, 42, 42, 42), rgba(42, 42, 42, 0));">
    </div>
