<footer class="bg-gray-800 text-white h-screen">
    <div class="flex flex-col">
        <div class="flex flex-col lg:flex-row w-full items-center lg:gap-8 gap-0 bg-[#2a2a2a] lg:pt-0 pt-12">
            <div class="w-full lg:w-1/2 flex justify-center lg:justify-start relative">
                <div class="absolute bg-[#4d4d4d] rounded-b-[80px] rounded-t-none shadow-2xl 2xl:-top-[13.9rem] xl:-top-[11.78rem] lg:-top-[11.78rem] lg:right-0 hidden lg:inline-block">
                    <img src="{{ asset('assets/asset/catalogue.png') }}" alt="Catalogue" class="relative 2xl:w-[28rem] xl:w-[24rem] lg:w-[24rem] h-auto object-contain py-12 px-12">
            ...
            <div class="w-full lg:w-1/2 py-10 lg:px-12 px-4 mt-[1rem]">
                ...
                <h3 class="2xl:text-[6rem] xl:text-[4rem] lg:text-[4rem]">Download <br> Our Catalogue</h3>
        ...
        <div class="flex flex-col lg:flex-row w-full h-auto">
            <div class="lg:w-1/2 w-full lg:text-right px-4 lg:px-0 mb-0 bg-[#666666]">
                ...
                <h1 class="2xl:text-[7rem] xl:text-[6rem] lg:text-[6rem] text-white mb-4">Hubungi <br> Kami <h1>
            </div>          
                ...
                <div class="flex flex-col lg:flex-row w-full lg:w-full pb-12 lg:pt-[6rem] px-4 text-black"> 
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        @foreach($office as $kantor)
                            <div class="text-left lg:text-left w-full lg:w-full xl:text-[1.2rem] lg:text-[1.2rem] 2xl:text-[1.6rem] lg:py-0 py-2">
